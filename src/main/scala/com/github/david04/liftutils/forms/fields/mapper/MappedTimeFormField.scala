 ...
 */
case class MappedTimeFormField[E <: Entity[E]](
                                                    instance: E,
                                                    private val _name: String,
                                                    protected val fld: E => MappedField[Int, E],
                                                    placeholder: String = "")
  extends TimeFormField(_name, () => fld(instance).get, fld(instance).apply _, placeholder)
