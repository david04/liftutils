...
case class MappedBooleanFormField[E <: Entity[E]](name: String, field: E => MappedField[Boolean, E], placeholder: String = "") extends FormField[E] {
  ...
  def render(saveAndRedirect: String => JsCmd, instance: E, row: Boolean, edit: Boolean, setTmp: Any => Unit, getTmp: () => Option[Any]) = new RederedFieldImpl[Boolean](setTmp, getTmp) {
